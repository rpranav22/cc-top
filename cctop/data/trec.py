...
class trec(TextDataset):
    ...
    def __init__(self, 
        ...
        super(trec, self).__init__(root, part, 
        ...
        self.coarse_grained = kwargs['coarse_grained']
    ...
    def download(self):
        ...
        if self.coarse_grained:
            y_train = self.data['train']['label-coarse']
            y_test = self.data['test']['label-coarse']
        else:
            y_train = self.data['train']['label-fine']
            y_test = self.data['test']['label-fine']
